...
const setCollapsedGroups = (groups) => {
...
const getLineDiff = (oldText, newText) => {
...
class EveryTextLineEditor {
    ...
    handleDocumentClick(event) {
        ...
        if (target.closest?.('.popup, dialog, .dialogue_popup')) return;
    ...
    renderStatusBar() {
        ...
        language.textContent = 'ST Prompt';
    ...
    updateStatusBar() {
        ...
        if (this.dom.statusLanguage) {
            this.dom.statusLanguage.textContent = 'ST Prompt';
        }
    }
