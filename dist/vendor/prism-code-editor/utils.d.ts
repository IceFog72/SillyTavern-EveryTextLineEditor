 ...
 * ```
 */
declare const getClosestToken: (editor: PrismEditor, selector: string, marginLeft?: number, marginRight?: number, position?: number) => HTMLSpanElement | null;
/**
...
export { regexEscape, getLineBefore, getLines, getClosestToken, getLanguage, insertText, getModifierCode, };
