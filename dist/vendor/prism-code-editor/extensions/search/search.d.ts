...
export interface SearchAPI {
     ...
     */
    search(str: string, caseSensitive?: boolean, wholeWord?: boolean, useRegExp?: boolean, selection?: [number, number], filter?: number | SearchFilter, wholeWordBoundry?: RegExp): string | void;
