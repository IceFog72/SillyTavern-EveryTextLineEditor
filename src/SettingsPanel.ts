...
export function renderSettingsPanel(host: SettingsPanelHost): HTMLElement {
    ...
    settingsBody.append(
        renderSharedEditorSettings(host),
        renderCoreEditorSettings(host),
        renderPrismSettings(host),
        renderMonacoSettings(host),
        renderHistorySettings(host),
    );
...
function renderSharedEditorSettings(host: SettingsPanelHost): HTMLElement {
...
function renderCoreEditorSettings(host: SettingsPanelHost): HTMLElement {
    const editorSelects = document.createElement('div');
    editorSelects.classList.add('etle--settingsGrid');
    editorSelects.append(
        renderSelectGroup(host, 'Engine', EDITOR_ENGINES, host.editorEngine.id, (value, select) => {
...
function renderPrismSettings(host: SettingsPanelHost): HTMLElement {
...
function renderMonacoSettings(host: SettingsPanelHost): HTMLElement {
...
function renderHistorySettings(host: SettingsPanelHost): HTMLElement {
...
function renderSelectGroup<T extends { id: string; label: string }>(
    host: SettingsPanelHost,
    label: string,
    options: readonly T[],
    value: string,
    onChange: (value: string, select: HTMLSelectElement) => void,
    onCreate?: (select: HTMLSelectElement) => void,
): HTMLDivElement {
