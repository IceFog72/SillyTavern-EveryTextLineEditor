...
export interface TextSource {
    ...
    metadata?: {
        ...
        role?: { get: () => string, set: () => void, label: () => string };
        triggers?: {
            get: () => string;
            set: (v: string) => void;
            label?: () => string;
        ...
        position?: { get: () => number, set: (delta: number) => void, label: () => string };
        depth?: { get: () => number, set: (v: number) => void };
        order?: { get: () => number, set: (v: number) => void };
    };
